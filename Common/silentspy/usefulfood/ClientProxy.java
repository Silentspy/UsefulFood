...
public class ClientProxy extends CommonProxy {
	public void addNames() {
		 ...
		 * LanguageRegistry.addName(UsefulFoodContent.bananapeeled,
		 * "Peeled Banana");
		 ...
		 * LanguageRegistry.addName(UsefulFoodContent.blueberrybush,
		 * "Blueberry Bush");
		 * LanguageRegistry.addName(UsefulFoodContent.strawberrybush,
		 * "Strawberry Bush");
		 * LanguageRegistry.addName(UsefulFoodContent.blueberryseed,
		 * "Blueberry Seed");
		 * LanguageRegistry.addName(UsefulFoodContent.strawberryseed,
		 * "Strawberry Seed");
		 * 
		 * LanguageRegistry.addName(UsefulFoodContent.strawberrysmoothie,
		 * "Strawberry Smoothie");
		 * LanguageRegistry.addName(UsefulFoodContent.bananasmoothie,
		 * "Banana Smoothie");
		 */

		LanguageRegistry.addName(UsefulFoodContent.magicapplejuice, "Magic Apple Juice");
		// LanguageRegistry.addName(UsefulFoodContent.blueberrysmoothie,
		// "Blueberry Smoothie");
		LanguageRegistry.addName(UsefulFoodContent.melonjuice, "Melon Juice");
		// LanguageRegistry.addName(UsefulFoodContent.orangejuice,
		// "Orange Juice");
		LanguageRegistry.addName(UsefulFoodContent.applejuice, "Apple Juice");
		// LanguageRegistry.addName(UsefulFoodContent.cherryjuice,
		// "Cherry Juice");
		// LanguageRegistry.addName(UsefulFoodContent.pearjuice, "Pear Juice");
		// LanguageRegistry.addName(UsefulFoodContent.peachjuice,
		// "Peach Juice");
