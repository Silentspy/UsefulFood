...
public final class UFDungeonLoot {
     ...
     *
     * @param itemstack The Item to be added to the loot list
     * @param minStack The chance it will spawn in a dungeon chest
     * @param maxStack the amount at a minimum it will spawn in a dungeon chest
     * @param weight the amount at a maximum it will spawn in a dungeon chest
     */
