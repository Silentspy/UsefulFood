...
public class UFConfig {
	...
	static int ChocolateFluidFlow;
	static int ChocolateFluidStill;
	...
	public static void Properties(FMLPreInitializationEvent event) 
	{
		...
		try {
			...
			//ChocolateFluidStill = cfg.getBlock("ChocolateFluidStill", 2238).getInt(2238);
			//ChocolateFluidFlow = cfg.getBlock("ChocolateFluidFlow", 2239).getInt(2239);
