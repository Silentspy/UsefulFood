...
public class UFItems 
{
	...
	public UFItems() 
	{
		...
		sugarbiscuit = new ItemFoodUF(UFConfig.sugarbiscuitItemID, "SugarBiscuit", 3, 0.3F, false);
		AppleJamBiscuit = new ItemFoodUF(UFConfig.applebiscuitItemID, "AppleJamBiscuit", 10, 0.3F, false);
		chocobiscuit = new ItemFoodUF(UFConfig.chocobiscuitItemID, "ChocolateBiscuit", 3, 1.0F, false);
		...
		CaramelIceCream = new ItemBowl(UFConfig.CaramelIceCreamItemID, "CaramelIceCream", 8, 0.6F, true).setPotionEffect(Potion.moveSpeed.id, 10, 0, 1.0F);
		...
		FrenchFries = new ItemFoodUF(UFConfig.FrenchFriesItemID, "FrenchFries", 7, 0.6F, false); 
		AppleJelly = new ItemBowl(UFConfig.AppleJellyItemID, "AppleJelly", 9, 0.4F, false).setPotionEffect(Potion.jump.id, 30, 0, 1.0F);
		MelonJelly = new ItemBowl(UFConfig.MelonJellyItemID, "MelonJelly", 7, 0.4F, false).setPotionEffect(Potion.jump.id, 30, 0, 1.0F);
		Donut = new ItemFoodUF(UFConfig.DonutitemID, "Donut", 7, 0.6F, false);
		Oreo = new ItemFoodUF(UFConfig.OreoItemID, "Oreo", 9, 1.0F, false);
		...
		SugarPancake = new ItemFoodUF(UFConfig.SugarPancakeItemID, "SugarPancake", 8, 0.6F, false).setPotionEffect(Potion.moveSpeed.id, 5, 0, 1.0F);
		...
		AppleJam = new ItemBowl(UFConfig.AppleJamItemID, "AppleJam", 8, 0.4F, false).setContainerItem(Item.bowlEmpty);
		...
		MelonJam = new ItemBowl(UFConfig.MelonJamItemID, "MelonJam", 6, 0.4F, false).setContainerItem(Item.bowlEmpty);
