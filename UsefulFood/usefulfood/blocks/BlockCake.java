...
public class BlockCake extends Block {
	...
	public BlockCake(int id, int blockindex, int foodlevel, float saturation, int cakeitemid) {
		super(id, blockindex, Material.cake);
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World,
		...
		return AxisAlignedBB.getAABBPool().addOrModifyAABBInPool(
				(double) ((float) par2 + var7), (double) par3,
				(double) ((float) par4 + var6),
				(double) ((float) (par2 + 1) - var6),
				(double) ((float) par3 + var8 - var6),
	...
	public int getBlockTextureFromSideAndMetadata(int par1, int par2) {
		return par1 == 1 ? this.blockIndexInTexture
				: (par1 == 0 ? this.blockIndexInTexture + 3 : (par2 > 0
						&& par1 == 4 ? this.blockIndexInTexture + 2
