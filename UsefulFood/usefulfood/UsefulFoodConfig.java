...
public class UsefulFoodConfig {
	...
	public static int FruitDropRateAnimals = 0;
	public static int FruitDropRateMonsters = 0;
	public static int FruitDropRateGrass = 1;
	
	public static boolean EnableStorageBlock = true;
	...
	public static void Properties(FMLPreInitializationEvent event) 
	{
		...
		try {
			...
			// Options
			UseVanillaRecipes = cfg.get(cfg.CATEGORY_GENERAL, "UseVanillaRecipes", false, "Set this to true to disable using Milk Bottles in Cake recipes").getBoolean(false);
			...
			FruitDropRateAnimals = cfg.get(cfg.CATEGORY_GENERAL, "FruitDropRateAnimals", 0, "Drop chance for fruits between from 1 to 100, default is 0 and 0 disables it").getInt(0);
			FruitDropRateMonsters = cfg.get(cfg.CATEGORY_GENERAL, "FruitDropRateMonsters", 0, "Drop chance for fruits between from 1 to 100, default is 0 and 0 disables it").getInt(0);
			FruitDropRateGrass = cfg.get(cfg.CATEGORY_GENERAL, "FruitDropRateGrass", 1, "Drop chance for fruits to drop from grass between from 1 to 100, default is 1 and 0 disables it").getInt(1);
			EnableStorageBlock = cfg.get(cfg.CATEGORY_GENERAL, "EnableStorageBlock", true).getBoolean(true);
			EnableBushes = cfg.get(cfg.CATEGORY_GENERAL, "EnableBushes", true).getBoolean(true);
