...
import silentspy.usefulfood.items.ItemBanana;
import silentspy.usefulfood.items.ItemBottle;
...
import silentspy.usefulfood.items.ItemMagicCake;
import silentspy.usefulfood.items.ItemMilkBottle;
import silentspy.usefulfood.items.ItemPumpkinsoup;
import silentspy.usefulfood.items.ItemSuperFruitSalad;
...
public class UsefulFoodItems {
	...
	public void init() 
	{
		milkbottle = new ItemMilkBottle(UsefulFoodConfig.milkbottleItemID, 0, 0).setIconIndex(11).setItemName("Milk");
		chocolate = new ItemBottle(UsefulFoodConfig.chocolateItemID, 4, 0.3F).setIconIndex(13).setItemName("Chocolate");
		...
		caramelapple = new ItemFoodStick(UsefulFoodConfig.caramelappleItemID, 9, 0.3F, false).setIconIndex(10).setItemName("CaramelApple");
		cookedseeds = new ItemUsefulFood(UsefulFoodConfig.cookedseedsItemID, 1, 0.1F, false).setIconIndex(2).setItemName("RoastedSeeds");
		friedegg = new ItemUsefulFood(UsefulFoodConfig.friedeggItemID, 3, 0.4F, true).setIconIndex(1).setItemName("FriedEgg");
		pumpkinsoup = new ItemPumpkinsoup(UsefulFoodConfig.pumpkinsoupItemID, 5).setIconIndex(0).setItemName("PumpkinSoup");
		...
		toast = new ItemUsefulFood(UsefulFoodConfig.toastItemID, 1, 0.1F, false).setIconIndex(20).setItemName("Breadslice");
		...
		biscuit = new ItemUsefulFood(UsefulFoodConfig.biscuitItemID, 1, 0.1F, true).setIconIndex(18).setItemName("Biscuit");
		trailmix = new ItemBowl(UsefulFoodConfig.trailmixItemID, 4, 0.0F,false).setIconIndex(7).setItemName("TrailMix");
		...
		hotchocolate = new ItemBottle(UsefulFoodConfig.hotchocolateItemID, 6,0.3F).setIconIndex(72).setItemName("HotChocolate");
		chocolateicecream = new ItemUsefulFood(UsefulFoodConfig.chocolateicecreamItemID, 8, 0.8F, true).setIconIndex(73).setItemName("ChocolateIcecream");
