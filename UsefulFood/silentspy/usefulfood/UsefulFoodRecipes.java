...
public class UsefulFoodRecipes {
	...
	private static void AddRecipes() {
		...
		GameRegistry.addRecipe(new ItemStack(UsefulFoodItems.applecake, 1), new Object[] { "AAA", "BBB", "CCC", 'A', UsefulFoodItems.milkbottle, 'B', Item.appleRed, 'C', Item.wheat });
		GameRegistry.addRecipe(new ItemStack(UsefulFoodItems.chococake, 1), new Object[] { "AAA", "BBB", "CCC", 'A', UsefulFoodItems.milkbottle, 'B', new ItemStack(Item.dyePowder, 1, 3), 'C', Item.wheat });
		GameRegistry.addRecipe(new ItemStack(UsefulFoodItems.magiccake, 1), new Object[] { "AAA", "BDB", "CCC", 'A', UsefulFoodItems.milkbottle, 'B', new ItemStack(Item.appleGold, 1, 1), 'C', Item.wheat, 'D', Item.speckledMelon });
		...
		GameRegistry.addRecipe(new ItemStack(UsefulFoodItems.Blueberrycake, 1), new Object[] { "AAA", "BBB", "CCC", 'A', UsefulFoodItems.milkbottle, 'B', new ItemStack(UsefulFoodItems.blueberry, 1, 1), 'C', Item.wheat });
		GameRegistry.addRecipe(new ItemStack(UsefulFoodItems.Strawberrycake, 1), new Object[] { "AAA", "BBB", "CCC", 'A', UsefulFoodItems.milkbottle, 'B', new ItemStack(UsefulFoodItems.strawberry, 1, 1), 'C', Item.wheat });
